...
# Source n-gram matching function
source("https://github.com/Chandar-ai/ngram_model_for_word_prediction/blob/main/Ngram_Word_Prediction_Function_For_ShinyApp.R")


# Define UI for application that takes a word or phrase as an input and predicts the next word as an output
ui <- fluidPage(
...
# Define Server logic to predict next word and display barplots

library(shiny)
library(png)

toptable4 = head(na.omit(readRDS("https://github.com/Chandar-ai/ngram_model_for_word_prediction/tree/main/ngram_app_data/four_words_fast.rds")))
toptable3 = head(na.omit(readRDS("https://github.com/Chandar-ai/ngram_model_for_word_prediction/tree/main/ngram_app_data/three_words_fast.rds")))
toptable2 = head(na.omit(readRDS("https://github.com/Chandar-ai/ngram_model_for_word_prediction/tree/main/ngram_app_data/two_words_fast.rds")))
